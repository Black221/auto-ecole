        ...
        <section id="service" className="bg-white">
            <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
                <div className="mx-auto max-w-screen-md text-center mb-8 lg:mb-12">
                    ...
                    Découvrez nos offres de formation à la conduite en ligne : optez pour notre pack Gratuit pour un test gratuit, ou choisissez le pack Medium pour un accès complet aux cours et tests. Préparez-vous à conduire en toute confiance!
                    </p>
                </div>
